namespace GridSystem.MergeSystem.View
{
    ...
    public sealed class UIMergeableObject : UIDraggableObject
    {
        [Inject]
        private void Construct(IIdentificationSystem identificationSystem, UIOverlapSystem overlapSystem, IMergeHandler mergeHandler)
        {
